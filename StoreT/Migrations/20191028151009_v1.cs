        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageUser_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    UserId = table.Column<string>(nullable: true),
                    QuantityOrders = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCabinets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserCabinets_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModelPhones_Firms_FirmId",
                        column: x => x.FirmId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Charachteristics_ModelPhones_ModelId",
                        column: x => x.ModelId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageModels_ModelPhones_ImageModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    QuantId = table.Column<int>(nullable: false),
                    Quantity = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuantityPhones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuantityPhones_ModelPhones_QuantId",
                        column: x => x.QuantId,
                        principalTable: "ModelPhones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Charachteristics_ModelId",
                table: "Charachteristics",
                column: "ModelId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ImageModels_ImageModelId",
                table: "ImageModels",
                column: "ImageModelId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModelPhones_FirmId",
                table: "ModelPhones",
                column: "FirmId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QuantityPhones_QuantId",
                table: "QuantityPhones",
                column: "QuantId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserCabinets_UserId",
                table: "UserCabinets",
                column: "UserId",
                unique: true,
                filter: "[UserId] IS NOT NULL");
